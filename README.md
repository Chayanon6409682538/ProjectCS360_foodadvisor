...
- [⚙️ How to Deploy and Run the Project Manually](#⚙️-how-to-deploy-and-run-the-project-manually)
- [⚙️ How to Deploy and Run the Project Using the Provided Bash Script](#⚙️-how-to-deploy-and-run-the-project-using-the-provided-bash-script-specify-the-bash-script-path-in-the-repo)
